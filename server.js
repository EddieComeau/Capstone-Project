...
const bufferTimeout = process.env.MONGOOSE_BUFFER_TIMEOUT_MS || process.env.MONGO_BUFFER_TIMEOUT_MS
  ? Number(process.env.MONGOOSE_BUFFER_TIMEOUT_MS || process.env.MONGO_BUFFER_TIMEOUT_MS)
  : 30000; // Was: 0
